...
public:
    ...
    char *get_gui_xml(const char *prefix) const { char xmlf[64]; snprintf(xmlf, sizeof(xmlf), "%s/%s", prefix, get_id()); char *data_ptr = calf_plugins::load_gui_xml(xmlf); return data_ptr; }
